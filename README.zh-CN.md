...
下次开 session,HUD 就出现在终端底部 —— 你的实时战况,一眼尽收:

![Slime HUD —— Cmd/Ctrl+点击 [HUD] 打开竞技场](docs/media/open-hud.png)

那个 **`[HUD]`** 是个可点链接:**Cmd+点击**(macOS)或 **Ctrl+点击**(Windows / Linux)就能在浏览器里打开完整竞技场 —— 或者跑 **`/slime:arena`**。把那个标签页摆在终端旁边,一边干活一边看打架。
